...
CORES_NORMAIS = [
    ("vermelho", "Vermelho", "<:1000010184:1482055334359994459>", 0xE74C3C),
    ("laranja",  "Laranja",  "<:1000010185:1482055374675775500>", 0xE67E22),
    ("amarelo",  "Amarelo",  "<:1000010186:1482055411115888700>", 0xF1C40F),
    ("verde",    "Verde",    "<:1000010187:1482055452249559041>", 0x2ECC71),
    ("azul",     "Azul",     "<:1000010188:1482055483593330738>", 0x3498DB),
    ("rosa",     "Rosa",     "<:1000010189:1482055506351755424>", 0xFF69B4),
    ("branco",   "Branco",   "<:1000010190:1482055535711752315>", 0xFFFFFF),
    ("marrom",   "Marrom",   "<:1000010191:1482055562739978443>", 0x8B4513),
    ("roxo",     "Roxo",     "<:1000010192:1482055595866456137>", 0x9B59B6),
]
...
CORES_DEGRADE = [
    ("grad_1",  "Degradê 1",  "<:1000010197:1482057156080435462>", "Degradê"),
    ("grad_2",  "Degradê 2",  "<:1000010198:1482057191446937794>", "Degradê"),
    ("grad_3",  "Degradê 3",  "<:1000010199:1482057214989435022>", "Degradê"),
    ("grad_4",  "Degradê 4",  "<:1000010200:1482057240163651746>", "Degradê"),
    ("grad_5",  "Degradê 5",  "<:1000010201:1482057268693434451>", "Degradê"),
    ("grad_6",  "Degradê 6",  "<:1000010203:1482057328629911695>", "Degradê"),
    ("grad_7",  "Degradê 7",  "<:1000010204:1482057355150753863>", "Degradê"),
    ("grad_8",  "Degradê 8",  "<:1000010205:1482057379926507540>", "Degradê"),
    ("grad_9",  "Degradê 9",  "<:1000010206:1482057891119894548>", "Degradê"),
    ("grad_10", "Degradê 10", "<:1000010207:1482057915375554580>", "Degradê"),
    ("grad_11", "Degradê 11", "<:1000010208:1482057938825777303>", "Degradê"),
]
...
class ColorNormalView(discord.ui.View):
    """View persistente — 9 cores normais em 2 linhas (5 + 4)."""
...
class Cores(commands.Cog):
    ...
    @app_commands.choices(cor=[
        ...
        app_commands.Choice(name="Degradê 9",  value="grad_9"),
        app_commands.Choice(name="Degradê 10", value="grad_10"),
        app_commands.Choice(name="Degradê 11", value="grad_11"),
    ])
